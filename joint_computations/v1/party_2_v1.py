...
class Party2v1:
    def __init__(self, template, n_split, n_threads):
        ...
        self.template_split = [t for t in np.hsplit(self.template, n_split)]
    ...
    def get_template_split_to_p1(self):
        ...
        """
        return [ts.ckks_tensor(self.context, t) for t in self.template_split]
    ...
    def dec_partial_res_from_p1(self, res_from_p1):
        ...
        return np.array(res_from_p1.decrypt().tolist()).T